...
/// update
    ...
    //cam_norm = normalize(cam_pos)*20.0f; // perspective

    float dist = sqrt(1 / 3.0);
    cam_norm = vec3(1,1,1)*dist; // isometric
...
/// draw
	    ...
	    //gluPerspective(45.0f,(GLfloat)800/(GLfloat)600,0.1f,1000.0f); // perspective
        float divisor = 70;
        glOrtho(-width/divisor, width/divisor, -height/divisor, height/divisor, -1000.0f, 1000.0f); // isometric
